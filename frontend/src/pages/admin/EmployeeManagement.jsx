    ...
    <MainLayout role="admin" pageTitle="Employee Management" userName="Admin User" userInitials="AU" notifCount={3}>
      ...
      <div className="em-anim" style={{fontFamily:'Poppins,sans-serif',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:24,flexWrap:'wrap',gap:16}}>
          ...
          <button style={{background:C.teal,color:'#fff',border:'none',borderRadius:10,padding:'10px 22px',fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:'Poppins,sans-serif',transition:'all .25s'}}
                  ...
                  <tr key={e.id} className="em-row" style={{background:i%2===0?'transparent':C.surfaceHover,transition:'background .15s',cursor:'pointer'}}>
                    ...
                    <td style={{...td,textAlign:'center'}}>
                      <div style={{display:'flex',gap:4,justifyContent:'center'}}>
                        <button className="em-abtn" title="View" onMouseEnter={e=>e.currentTarget.style.background=`${C.cyan}18`} onMouseLeave={e=>e.currentTarget.style.background='transparent'}><EyeIco color={C.cyan}/></button>
                        <button className="em-abtn" title="Edit" onMouseEnter={e=>e.currentTarget.style.background=C.accentLight} onMouseLeave={e=>e.currentTarget.style.background='transparent'}><PenIco color={C.accent}/></button>
                        <button className="em-abtn" title="Delete" onMouseEnter={e=>e.currentTarget.style.background='rgba(239,68,68,.12)'} onMouseLeave={e=>e.currentTarget.style.background='transparent'}><TrashIco color={C.danger}/></button>
                      </div>
                    </td>
                  </tr>
                );
            ...
            return (
              <div key={e.id} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:18,transition:'all .2s'}}
                ...
                <div style={{display:'flex',gap:6,justifyContent:'flex-end'}}>
                  <button className="em-abtn" style={{background:`${C.cyan}18`}}><EyeIco color={C.cyan}/></button>
                  <button className="em-abtn" style={{background:C.accentLight}}><PenIco color={C.accent}/></button>
                  <button className="em-abtn" style={{background:'rgba(239,68,68,.12)'}}><TrashIco color={C.danger}/></button>
                </div>
              </div>
            );
          })}
