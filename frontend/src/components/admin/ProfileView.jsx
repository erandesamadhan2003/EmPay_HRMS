...
export default function ProfileView() {
  ...
  // Flatten profile data: merge user fields with nested profile object
  ...
  const profileUser = {
    ...
    designation: p.designation || p.jobTitle || '—',
    joinDate: p.joiningDate || p.date_of_joining || p.createdAt || '',
    loginId: p.loginId || p.login_id || p.employeeId || '—',
    role: p.role || 'Admin',
  };
